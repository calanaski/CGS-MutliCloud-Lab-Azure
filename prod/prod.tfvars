...
sharedservice-defaultroute-gateway  = "10.0.16.68" //The address of the Palo Altos to send the default route to
sharedservice-dns-servers           = ["168.63.129.16"] //This should list the servers that provide DNS for the tenants
cloud-name                          = "CAZ"
tenant-environment-name             = "prod"
tenant-environment-abbreviation     = "P"
...
//IP Information
tenant-vnet-cidr-block              = ["10.203.0.0/22"] //should be considered in Terraform Enterprise Environment Variables
tenant-subnets = [
  {
    subnet_address                  = ["10.203.0.0/25"] //should be considered in Terraform Enterprise Environment Variables
    subnet_name                     = "Web"
  },
  {
    subnet_address                  = ["10.203.1.0/25"] //should be considered in Terraform Enterprise Environment Variables
    subnet_name                     = "Application"
  },
  {
    subnet_address                  = ["10.203.2.0/25"] //should be considered in Terraform Enterprise Environment Variables
